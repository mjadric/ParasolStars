...
// MAPA I LIKOVI U IGRI (UCITAVANJE,BRISANJE...)
/** @type {Game} */
var GAME = null;
...
//! sučelje
const btnStart = document.getElementById("btnStart"); //POKRETANJE IGRE
const btnStop = document.getElementById("btnStop"); // ZAUSTAVLJENJE IGRE
const btnMaps = document.getElementById("btnMaps"); //DOHVACA MAPE IZ INDEX.HTML
